...
let kConnectionName = "com.amaravrokeyboard.inputmethod.AmarAvroKeyboard_Connection"

// IMKServer must be a global to stay alive for the process lifetime
var server: IMKServer!

// Build identifier — check Console.app for the product name to verify the build.
let amarAvroBuildId = "amar-avro-keyboard-0.6.0"
NSLog("Amar Avro Keyboard: starting %@", amarAvroBuildId)
...
func installMainMenu() {
    ...
    let appMenu = NSMenu(title: "Amar Avro Keyboard")
...
// Register the official full-colour brand icon before IMKServer loads it.
